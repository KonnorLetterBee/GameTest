...
public class CLScenario extends CardList {
	private int mode;
	private int expans;
	...
	/**
	 * Constructs a default CLScenario
	 */
	public CLScenario () {
		super();
		this.mode = -1;
	...
	/**
	 * Constructs a CLScenario with specified attributes.
	 * @param id     The CLScenario's ID number
	 * @param name   The name of the CLScenario
	 * @param tags   The list of tags with which to construct the scenario
	 * @param desc   The description of the CLScenario
	 * @param notes  The developer notes attached to the CLScenario
	 * @param loadImmediately  If true, load the cards during construction rather than manually afterwards
	 */
	public CLScenario (int id, String name, String[] tags, String desc, String notes, int mode, int expans, boolean basics, boolean loadImmediately) {
	...
	/**
	 * Constructs a CLScenario by reading information from either an external file or database table.
	 ...
	 */
	public CLScenario (boolean file, String path, boolean loadImmediately) throws IOException, MethodNotSupportedException {
	...
	/**
	 * Loads the CLScenario information stored in an external file into this CLScenario.  Does not load the Card objects themselves.
	 * @param path  The file from which the CLScenario is to get information
	 ...
	 * @throws NullPointerException if the CLScenario hasn't been given a path to save to
	 */
	...
	/**
	 * Updates the stored path string of this CLScenario, then saves the information of this CLScenario to an external file.  Does 
	 * not save the data for the Card objects themselves.
	 * @param path  The file from which the CLScenario is to write information
	 * @throws IOException if the file could not be saved
	 * @throws NullPointerException if the CLScenario hasn't been given a path to save to
	 */
