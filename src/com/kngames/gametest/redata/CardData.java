...
public class CardData {
	...
	public static final ActionCard[] Actions = {
		...
		new ActionCard("Deadly Aim",						2,  0, 5,  50, 0, 0,  20, 0, 0, 0, "All your Weapons get +10 Damage this turn."),
		new ActionCard("Shattered Memories",				3,  0, 5,  20, 0, 0,  0,  0, 0, 0, "Trash up to 2 cards from your Discard Pile.  Then Trash this card."),
		new ActionCard("Escape from the Dead City",			4,  0, 10, 70, 2, 0,  0,  1, 0, 0, ""),
		new ActionCard("Reload",							5,  0, 5,  50, 2, 0,  20, 0, 0, 0, "Move 1 Weapon from your Discard Pile to your Hand."),
		new ActionCard("The Merchant",						6,  0, 6,  50, 0, 20, 0,  1, 1, 0, ""),
		new ActionCard("Umbrella Corporation",				7,  0, 5,  50, 1, 0,  0,  2, 0, 0, "Move 1 card from your Hand to the top of your Inventory."),
