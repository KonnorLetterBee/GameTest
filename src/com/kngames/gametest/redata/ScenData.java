...
public class ScenData {
	...
	public static final Scenario[] Scenarios = {
		new Scenario ("First Timer", GameMode.Story, Expans.Base, true, new String[] {
				"AC07", "AC01", "AC04", "AC02", "AC03", "AC06", "AC05", "WE01", "WE08", "WE13 WE14", "WE15 WE16", "WE11 WE12"},
				"", null),
		new Scenario ("Classic Horror", GameMode.Story, Expans.Base, true, new String[] {
		...
		new Scenario ("Spy Games", GameMode.Story, Expans.Base, true, new String[] {
		...
		new Scenario ("Whaddya Buyin?", GameMode.Story, Expans.Base, true, new String[] {
		...
		new Scenario ("Battle-Hardened Veteran", GameMode.Story, Expans.Base, true, new String[] {
		...
		new Scenario ("Special Forces", GameMode.Mercenary, Expans.Base, true, new String[] {
		...
		new Scenario ("Limited Movement", GameMode.Mercenary, Expans.Base, true, new String[] {
		...
		new Scenario ("Jack Of All Trades", GameMode.Mercenary, Expans.Base, true, new String[] {
				"AC04", "AC05", "AC02", "AC09", "AC3", "AC11", "AC06", "WE01", "WE13 WE14", "WE15 WE16", "WE11 WE12", "WE08"},
				"", null),
		new Scenario ("Quick And Easy", GameMode.Versus, Expans.Base, true, new String[] {
		...
		new Scenario ("Big Guns, Big Explosions", GameMode.Versus, Expans.Base, true, new String[] {
		...
		new Scenario ("I've Covered Wars", GameMode.Versus, Expans.Base, true, new String[] {
		...
		new Scenario ("Initial Horror", GameMode.Story, Expans.Alliaces, true, new String[] {
				"AC17", "AC21", "AC22", "AC19", "AC14", "AC18", "IT04", "WE19", "WE20 WE21", "WE17 WE18", "WE22 WE23"},
				"", null),
		new Scenario ("Bound Advance", GameMode.Story, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Backlog", GameMode.Story, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Fast Action", GameMode.Story, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Lethal Injection", GameMode.Story, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Top of the Class", GameMode.Story, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Partners in Escape", GameMode.PartnerStory, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("A Little Gun Goes A Long Way", GameMode.PartnerStory, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Tactical Advance", GameMode.PartnerStory, Expans.Alliaces, true, new String[] {
		...
		new Scenario ("Outbreak", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
				"WE15 WE16", "WE29 WE30", "WE28", "WE13 WE14", "AC26", "AC24", "AC01", "AC25", "AC23", "AC02", "AC06", "AC03", "AC04"},
				"", null),
		new Scenario ("Dawn of Nightmares", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
				"WE19", "WE20 WE21", "AC19", "AC24", "AC23", "AC25", "AC17", "AC21", "AC22", "WE29 WE30", "AC26", "WE22 WE23"},
				"", null),
		new Scenario ("Infection Balance", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Duplicity", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Embrace the Darkness", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
				"WE01", "AC27", "AC10", "AC02", "AC23", "WE08", "AC03", "AC31", "AC28", "WE03", "WE15 WE16", "WE13 WE14"},
				"Being an Infected isn't all that bad..... is it?", null),
		new Scenario ("Quick Game", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Trouble Around Every Corner", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Resident Reaper", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Explosions and Flames", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Mega Money", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
				"AC09", "AC06", "WE08", "AC29", "WE24", "WE20 WE21", "AM04", "AC03", "AC21", "WE02", "WE29 WE30", "AC30"},
				"", null),
		new Scenario ("A Gun Is a Gun", GameMode.Outbreak, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Special Forces", GameMode.Mercenary, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Jack of All Trades", GameMode.Mercenary, Expans.Outbreak, true, new String[] {
		...
		new Scenario ("Limited Movement", GameMode.Mercenary, Expans.Outbreak, true, new String[] {
				"WE15 WE16", "WE13 WE14", "AC06", "AC09", "AC24", "AC11", "AC02", "AC30", "AC03", "WE01", "WE29 WE30", "WE11 WE12"},
				"Make no wasted movements as your Team will be down to one or two Actions per turn. Make every card count and you will come out victorious!", null),
		new Scenario ("Infested Supply Depot", GameMode.Mercenary, Expans.Outbreak, true, new String[] {
				"WE28", "WE20 WE21", "AC15", "WE24", "WE26 WE27", "AC19", "AC18", "AC21", "AC22", "AC17", "AC24", "WE22 WE23"},
				"Featuring all the Weapons you could ever need, this abandoned Supply Depot guarantees one thing: Mass Destruction.", null),
		new Scenario ("Infested Shopping Mall", GameMode.Mercenary, Expans.Outbreak, true, new String[] {
				"WE19", "WE20 WE21", "AC15", "AC13", "AC14", "AC19", "IT04", "WE29 WE30", "AC22", "AC17", "AM04", "WE22 WE23"},
				"Welcome to Raccoon City Mall, where anything great is located, everything is on sale, and everyone greets you with rotting teeth and a monstrous hunger! We've got what cures your hunger for Infected destruction!", null),
		new Scenario ("Nightmare", GameMode.Story, Expans.Nightmare, true, new String[] {
			"WE36 WE37", "AC32", "AC37", "AC33", "WE35", "AC39", "WE41", "AC35", "AC36", "AC10", "AC04", "WE38 WE39"},
			"", null),
		new Scenario ("Biohazard", GameMode.Story, Expans.Nightmare, true, new String[] {
			"AC17", "AC36", "AC22", "AC35", "WE35", "AC37", "AC41", "AC34", "WE20 WE21", "WE36 WE37", "WE38 WE39"},
			"", null),
		new Scenario ("Bigger is Better", GameMode.Story, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Hoarding", GameMode.Story, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Disposable", GameMode.Story, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Millionaire", GameMode.Story, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Competitive", GameMode.Story, Expans.Nightmare, true, new String[] {
			"WE31", "WE34", "WE35", "AC03", "AC29", "AC21", "AC02", "AC17", "AC26", "WE28", "WE32 WE33", "AC06"},
			"There is no one way to win with this Scenario", null),
		new Scenario ("Sacrifice", GameMode.Mercenary, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Sluggish", GameMode.Mercenary, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Zombie Hunters", GameMode.Mercenary, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Infested Police Station", GameMode.Mercenary, Expans.Nightmare, true, new String[] {
		...
		new Scenario ("Infested Gun Shop", GameMode.Mercenary, Expans.Nightmare, true, new String[] {
	...
	public static ArrayList<Pair<Integer,Scenario>> loadCustomScenarios() {
		...
		if (scens.moveToFirst()) {
			do {
				...
				out.add(new Pair<Integer,Scenario>(id, new Scenario(name, gameMode, Expans.Custom, usesBasics, contents, desc, notes)));
