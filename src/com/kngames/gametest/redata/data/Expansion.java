...
public class Expansion {
	...
	public static class BaseSet extends Expansion {
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			...
			new WeaponCard("Longbow", 						2,  0, WeaponType.none, 	  110, 0,  25, false, 5, ""),
			...
			new WeaponCard("Burst-Fire Handgun",			7,  4, WeaponType.Pistol, 	  60,  30, 20, false, 1, "While Attacking with more than 1 Weapon, this Weapon gets +20 Damage during this turn."),
			new WeaponCard("Six Shooter", 					8,  0, WeaponType.Magnum, 	  90,  50, 50, false, 5, ""),
			new WeaponCard("Gatling Gun", 					9,  0, WeaponType.none, 	  110, -1, -1, false, 1, ""),
	...
	public static class AlliancesExpans  extends Expansion{
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			...
			new WeaponCard("Russian Assault Rifle", 		22, 1, WeaponType.Rifle,	  40,  -1, -1, false, 4, "You cannot use more than 20 Ammo for this Weapon."),
			new WeaponCard("Signature Special", 			23, 1, WeaponType.Rifle,	  70,  -1, -1, false, 1, "You cannot use more than 60 Ammo for this Weapon."),
