...
public class Expansion {
	...
	public static class BaseSet extends Expansion {
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			new WeaponCard("Grenade", 						1,  0, WeaponType.Explosive,  40,  0,  15, true,  5, "Story Mode or Mercenary Mode:  Deal 5 additional damage to each adjacent Player to the Attacking Player.\nVersus Mode:  Deal an additional 5 Damage to each adjacent Player to the Attacked Player."),
			new WeaponCard("Longbow", 						2,  0, WeaponType.Bow, 	  	  110, 0,  25, false, 5, ""),
			new WeaponCard("Submission", 					3,  0, WeaponType.Melee, 	  20,  0,  5,  false, 5, "Story Mode or Mercenary Mode:  This Weapon gets +5 Damage while your Character's Health is 80 or higher.\nVersus Mode:  Attacked Player must discard a Weapon from their hand."),
			new WeaponCard("Combat Knife", 					4,  4, WeaponType.Knife,	  0,   0,  5,  false, 11, ""),
			new WeaponCard("Survival Knife", 				5,  4, WeaponType.Knife, 	  50,  0,  10, false, 1, "This Weapon gets +5 Damage for every other Knife Weapon used this turn.", new SurvivalKnifeEffect(), null),
			new WeaponCard("Handgun", 						6,  4, WeaponType.Pistol, 	  20,  20, 10, false, 9, ""),
			new WeaponCard("Burst-Fire Handgun",			7,  4, WeaponType.Pistol, 	  60,  30, 20, false, 1, "While Attacking with more than 1 Weapon, this Weapon gets +20 Damage during this turn.", new BurstFireHandgunEffect(), null),
			new WeaponCard("Six Shooter", 					8,  0, WeaponType.Magnum, 	  90,  50, 50, false, 5, ""),
			new WeaponCard("Gatling Gun", 					9,  0, WeaponType.Minigun, 	  110, -1, -1, false, 1, ""),
			new WeaponCard("Rocket Launcher", 				10, 0, WeaponType.Explosive,  130, 0,  90, true,  1, "When Trashed, shuffle the the \"Rocket Launcher Case\" Token into the Mansion."),
			new WeaponCard("Assault Machine Gun", 			11, 0, WeaponType.MachineGun, 30,  40, 20, false, 4, ""),
			new WeaponCard("Full-Bore Machine Gun", 		12, 0, WeaponType.MachineGun, 100, 70, 40, false, 1, "If you have more than 100 Ammo, this Weapon gets +30 Damage."),
			new WeaponCard("Pump-Action Shotgun", 			13, 0, WeaponType.Shotgun, 	  40,  40, 25, false, 4, "You get +1 Explore this turn."),
			new WeaponCard("Automatic Shotgun", 			14, 0, WeaponType.Shotgun, 	  80,  80, 50, false, 1, "The next time an Infected is Revealed this turn, if its Health is 40 or lower, defeat it immediately.  Additionally, you get +1 Explore this turn."),
			new WeaponCard("Bolt-Action Rifle", 			15, 0, WeaponType.Rifle, 	  50,  50, 20, false, 4, "Reveal the top card of your Inventory.  If its cost is 40 or more, this Weapon gets +30 Damage this turn."),
			new WeaponCard("Semi-Automatic Rifle", 			16, 0, WeaponType.Rifle, 	  90,  70, 30, false, 1, "This Weapon gets +10 Damage for every Action played this turn."),
		}; }
		public ActionCard[] actions() { return new ActionCard[] {
			...
			new ActionCard("Shattered Memories",				3,  0, 5,  20, 0, 0,  0,  0, 0, 0, "Trash up to 2 cards from your Discard Pile.  Then Trash this card.", new CardEffects.ShatteredMemoriesEffect(), new CardEffects.TrashOnFinish(), null),
			...
			new ActionCard("Back to Back",						8,  0, 5,  30, 1, 10, 0,  0, 0, 0, "When your Character is Attacked, you can Discard this card from your Hand to give 1 Weapon -20 Damage this turn.", new CardEffects.BackToBackEffect(), null, new CardEffects.BackToBackTrigger()),
			new ActionCard("Item Management",					9,  0, 5,  30, 0, 0,  0,  0, 0, 0, "Trash 1 Ammunition from your Hand to Gain another Ammunition costing up to 30 Gold more than the Trashed card.", new CardEffects.ItemManagementEffect()),
			new ActionCard("Ominous Battle",					10, 0, 5,  60, 0, 10, 0,  3, 0, 0, "Trash 1 Card from your Hand.", new CardEffects.OminousBattleEffect()),
			new ActionCard("Master of Unlocking",				11, 0, 3,  30, 1, 0,  0,  0, 0, 0, "Each other Player reveals the top card of their Inventory.  You can Gain 1 of the Revealed Weapons.  All the other Revealed cards are Discarded afterwards.", new CardEffects.MasterOfUnlockingEffect()),
		...
		public MansionCard[] mansion() { return new MansionCard[] {
			new InfectedCard("Majini", 				1,  3, 0, 15, 10, 1, false, ""),
			new InfectedCard("Zombie (Male)", 		2,  2, 0, 20, 20, 1, false, ""),
			new InfectedCard("Zombie (Female)", 	3,  2, 0, 15, 10, 1, false, "When this Infected is Defeated, choose a Player.  That Player cannot play Actions on their next turn."),
			new InfectedCard("Zombie Butcher", 		4,  3, 0, 15, 10, 1, false, "When this Infected is Defeated, choose a Player and skip that Player's next turn."),
			new InfectedCard("Bui Kichwa", 			5,  3, 0, 10, 10, 1, false, ""),
			new InfectedCard("Licker", 				6,  3, 0, 40, 30, 3, false, ""),
			new InfectedCard("Nemesis T-Type", 		7,  1, 0, 60, 40, 5, false, "When this Infected is Revealed, each Player takes 20 Damage."),
			new InfectedCard("Hunter", 				8,  2, 0, 40, 30, 4, false, "If this Infected was not Defeated, randomly Trash 2 cards from the Attacking Player's Discard Pile."),
			new InfectedCard("Mimicry Marcus", 		9,  2, 0, 30, 20, 2, false, ""),
			new InfectedCard("Uroboros Aheri", 		10, 1, 0, 90, 70, 8, false, "If this Infected was not Defeated, Shuffle it into the Mansion."),
			new InfectedCard("Dr. Salvador", 		11, 3, 0, 20, 15, 2, false, ""),
			new TokenCard(   "Rocket Launcher Case",12,    0, "Gain 1 \"Rocket Launcher\" Weapon.  Remove this card from the game afterwards.",
					new CardEffects.RocketCaseEffect(), null),
			new TokenCard(   "Gatling Gun Case", 	13,    0, "Gain 1 \"Gatling Gun\" Weapon.  Remove this card from the game afterwards.",
					new CardEffects.GGunCaseEffect(), null),
			new InfectedCard("Gatling Gun Majini", 	14, 3, 0, 40, 25, 4, false, "This Infected gets +5 Damage for every 10 Ammo the Attacking Player has."),
			new InfectedCard("Cerberus", 			15, 3, 0, 25, 10, 2, false, ""),
			new InfectedCard("El Gigante", 			16, 1, 0, 40, 40, 4, false, ""),
			new InfectedCard("Executioner", 		17, 1, 0, 30, 25, 3, false, "")
		}; }
	...
	public static class AlliancesExpans  extends Expansion{
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			new WeaponCard("Flash Grenade", 				17, 1, WeaponType.Explosive,  20,  0,  0,  true,  5, "The next time a \"Las Plagas\" Infected is Revealed this turn, Defeat it immediately.  While your Character(s) is/are Battling, you can move 1 Infected with 20 or less Health to the bottom of the Mansion."),
			new WeaponCard("Grenade Launcher", 				18, 1, WeaponType.Explosive,  80,  0,  20, false, 1, "All \"Explosive\" Weapons your Character uses during this turn go to your Discard Pile instead of being Trashed."),
			new WeaponCard("Telescopic Sight Rifle", 		19, 1, WeaponType.Rifle,	  50,  50, 30, false, 7, "During this turn, when your Character Explores, Reveal the bottom of the Mansion instead of the top."),
			new WeaponCard("Riot Shotgun", 					20, 1, WeaponType.Shotgun,	  70,  60, 45, false, 7, "You get +1 Explore this turn."),
			new WeaponCard("Triple-Barreled Shotgun", 		21, 1, WeaponType.Shotgun,	  90,  80, 50, false, 1, "You get +2 Explore this turn.  This Weapon gets +10 Damage during this turn for every Infected your Character(s) is/are Battling."),
			new WeaponCard("Russian Assault Rifle", 		22, 1, WeaponType.MachineGun, 40,  -1, -1, false, 4, "You cannot use more than 20 Ammo for this Weapon."),
			new WeaponCard("Signature Special", 			23, 1, WeaponType.MachineGun, 70,  -1, -1, false, 1, "You cannot use more than 60 Ammo for this Weapon."),
			new WeaponCard("Flamethrower", 					24, 1, WeaponType.none,		  90,  0,  -1, false, 5, "X() { return 5 times the number of cards in your Discard Pile."),
			new WeaponCard("Blowback Pistol", 				25, 1, WeaponType.Pistol,	  40,  30, 20, false, 5, "You can Discard any number of \"Pistol\" Weapons from your Hand to give this Weapon +10 Damage during this turn for each \"Pistol\" Weapon Discarded due to this effect."),
		}; }
		public ActionCard[] actions() { return new ActionCard[] {
		...
		public MansionCard[] mansion() { return new MansionCard[] {
			new InfectedCard("Lurker", 				22, 3, 1, 10, 10, 1, false, ""),
			new InfectedCard("Infected Bat", 		23, 3, 1, 15, 20, 1, false, "While this Infected is being Attacked with another Infected, this Infected gets +20 Health during this turn."),
			new InfectedCard("Licker Beta", 		24, 2, 1, 30, 20, 3, false, ""),
			...
			new InfectedCard("Garrador", 			26, 2, 1, 50, 40, 4, false, ""),
			new InfectedCard("Zombie (Male)", 		27, 3, 1, 20, 10, 1, false, ""),
			new InfectedCard("Kipepo", 				28, 3, 1, 20, 20, 1, true,  ""),
			new InfectedCard("Albert Wesker", 		29, 1, 1, 90, 70, 9, false, "When this Infected is Revealed, all other Revealed Infected get +10 Health and +10 Damage during this turn."),
			...
			new InfectedCard("Proto Tyrant", 		31, 1, 1, 60, 40, 5, false, "When this Infected is Revealed, all non-Exploring Characters with 50 or more Health take 40 Damage."),
			new InfectedCard("Iron Maiden", 		32, 2, 1, 50, 30, 4, false, ""),
			new InfectedCard("Zombie Horde", 		33, 3, 1, 30, 20, 2, false, ""),
			new InfectedCard("Nosferatu",	 		34, 2, 1, 55, 30, 4, false, ""),
			new InfectedCard("Los Illuminados Monk",35, 2, 1, 15, 20, 3, false, "When this Infected is Revealed, it gets +5 Health and +5 Damage for each Infected attached to the Exploring Main Character."),
			new InfectedCard("Reaper",		 		36, 2, 1, 35, 40, 4, false, "When this Infected is Defeated, if it wasn't Defeated with Damage equal to its Health, the Attacking Player Trashes 1 of the cards attached to their Main Character's Partner with the highest cost, if any."),
			new InfectedCard("Guardian of Insanity",37, 3, 1, 30, 20, 2, false, "When this Infected is Revealed, each Player takes 10 Damage."),
	...
	public static class OutbreakExpans  extends Expansion{
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			new WeaponCard("Standard Sidearm", 				26, 2, WeaponType.Pistol,	  30,  10, 10, false, 4, "This Weapon gets +5 Damage for each non-Item you Gained this turn."),
			new WeaponCard("Samurai Edge", 					27, 2, WeaponType.Pistol,	  70,  60, 30, false, 1, "This Weapon gets +20 Damage for each card you Gained this turn."),
			new WeaponCard("Stun Rod", 						28, 2, WeaponType.Melee,	  30,  0,  10, false, 5, "You get +1 Explore this turn.  While your Character is Battling 2 or more Infected, you can move 1 of those Infected with 20 or less Health to the top of the Mansion."),
			new WeaponCard("Lightning Hawk", 				29, 2, WeaponType.Magnum,	  100, 60, 60, false, 4, ""),
			new WeaponCard("Hand Cannon", 					30, 2, WeaponType.Magnum,	  120, 80, 80, false, 1, "Trash 1 Ammunition from your Play Area.  This card cannot be attached to Characters."),
			new WeaponCard("Night Scope Rocket Launcher", 	31, 2, WeaponType.Explosive,  80,  0,  60, true,  5, "While it is nighttime outside of the game, this Weapon gets +20 Damage."),
		}; }
		public ActionCard[] actions() { return new ActionCard[] {
		...
		public MansionCard[] mansion() { return new MansionCard[] {
			new InfectedCard("Tyrant T-002", 		41, 1, 2, 90, 70, 8, false, "When this Infected was not Defeated, increase the Exploring Character's Infection Level by 1 plus their current Level, then shuffle this Infected into the Mansion."),
			new InfectedCard("Yawn", 				42, 2, 2, 40, 30, 4, false, "When this Infected is Revealed, if the Exploring Character's Infection Level is 5 or less, increase it by 2.  Otherwise, increase it by 1."),
			new InfectedCard("Nemesis (2nd Form)", 	43, 1, 2, 60, 40, 5, false, "When this Infected is Revealed, increase the Infection Level of all Characters by 1."),
			new InfectedCard("Grave Zombie", 		44, 3, 2, 10, 10, 1, false, ""),
			new InfectedCard("Wasp", 				45, 2, 2, 15, 0 , 2, false, "When this Infected is Revealed, the Exploring Character takes 20 Damage."),
			new InfectedCard("Web Spinner", 		46, 2, 2, 30, 10, 3, false, "When this Infected was not Defeated, increase the Exploring Character's Infection Level by 1."),
			new InfectedCard("Reinforced Zombie", 	47, 3, 2, 20, 10, 1, false, "While this Infected is attached to a Character, that Character's Decoration Requirements for Level 2 is reduced by 1."),
			new InfectedCard("Crimson Head", 		48, 2, 2, 40, 20, 4, false, "When this Infected is Revealed, if the Exploring Character has 1 or more Infected with \"Zombie\" in its name attached to them, this Infected gets +10 Health and +10 Damage during this turn."),
			new InfectedCard("Reinforced Licker", 	49, 3, 2, 30, 20, 3, false, "When this Infected is Revealed, Weapons with 0 Ammo Requirement deal 0 Damage during this turn."),
			new InfectedCard("Grave Digger", 		50, 2, 2, 30, 30, 3, false, ""),
			new InfectedCard("Zombie Cop", 			51, 3, 2, 15, 10, 1, false, ""),
			new InfectedCard("Eliminator", 			52, 2, 2, 20, 20, 2, false, ""),
			new InfectedCard("Lisa Trevor", 		53, 1, 2, 40, 20, 0, false, "When this Infected is Defeated, increase a Character's Infection Level by 1, then move this Infected to the bottom of the Mansion."),
	...
	public static class NightmareExpans  extends Expansion{
		...
		public WeaponCard[] weapons() { return new WeaponCard[] {
			new WeaponCard("Silver Ghost", 					32, 3, WeaponType.Pistol,	  30,  10, 10, false, 4, "You get +1 Card and +1 Action during this turn."),
			new WeaponCard("Punisher", 						33, 3, WeaponType.Pistol,	  70,  30, 30, false, 1, "You get +2 Cards and +1 Action during this turn."),
			new WeaponCard("Mine Thrower", 					34, 3, WeaponType.Explosive,  120, 0,  0,  false, 5, "This Weapon gets +10 Damage during this turn for each Ammunition in your Play Area."),
			new WeaponCard("Broken Butterfly", 				35, 3, WeaponType.Magnum,	  80,  40, 40, false, 5, "This Weapon gets +20 Damage if the Exploring Character's Player has 10 or more cards in their inventory."),
			new WeaponCard("Single Shot Rifle W/ Scope", 	36, 3, WeaponType.Rifle,	  50,  40, 30, false, 4, "Select a Player.  That Player Discards 1 card from their Hand."),
			new WeaponCard("Special Ops Rifle", 			37, 3, WeaponType.Rifle,	  80,  50, 50, false, 1, "Every non-Exploring Character's Player Discards 1 card from their Hand."),
			new WeaponCard("Machine Pistol W/ Stock", 		38, 3, WeaponType.MachineGun, 40,  30, 20, false, 4, "You get +20 Gold during this turn."),
			new WeaponCard("Gangster's Machine Gun", 		39, 3, WeaponType.MachineGun, 80,  50, 50, false, 1, "This Weapon gets +10 Damage during this turn for each \"Machine Gun\" Weapon in your Discard Pile."),
			new WeaponCard("Flashbang", 					40, 3, WeaponType.Explosive,  20,  0,  10, true,  5, "You get +1 Explore this turn.  Additionally, while your Character is Exploring, all Revealed Infected with 40 or less Health deal 0 Damage."),
			new WeaponCard("HE Grenade", 					41, 3, WeaponType.Explosive,  40,  0,  20, true,  5, ""),
			new WeaponCard("Incendiary Grenade", 			42, 3, WeaponType.Explosive,  30,  0,  10, true,  5, "This Weapon gets +5 Damage this turn for each Infected your Character is Battling against.")
		}; }
		public ActionCard[] actions() { return new ActionCard[] {
		...
		public MansionCard[] mansion() { return new MansionCard[] {
			new InfectedCard("Osmund Saddler", 			58, 1, 3, 90, 60, 8, false, "When this Infected is not Defeated, the Exploring Character's Player Gains 1 \"Ammo x10\", then an \"Ammo x10\" for each Level their Character has.  Then shuffle this Infected into the Mansion."),
			new InfectedCard("Bitores Mendez", 			59, 1, 3, 70, 50, 6, false, "When this Infected is Defeated, the Exploring Character's Player gets an extra turn after this one."),
			new InfectedCard("Regenerator", 			60, 2, 3, 40, 20, 4, false, "When this Infected is Revealed, all Weapons that are being used get -10 Damage during this turn."),
			new InfectedCard("Jack Krauser", 			61, 1, 3, 50, 30, 4, false, "When this Infected is Defeated, the Exploring Character's Player can Gain any card from the Resource Area that is on top of a Resource Pile."),
			new InfectedCard("Colmillos", 				62, 3, 3, 30, 20, 2, false, ""),
			new InfectedCard("Militia (Flail)", 		63, 3, 3, 15, 10, 1, false, ""),
			new InfectedCard("Militia (Stun Rod)", 		64, 2, 3, 20, 10, 1, false, ""),
			new InfectedCard("Militia (Rocket Launcher)",65, 2, 3, 30, 0, 2, false, "When this Infected is Revealed, the Exploring Character takes 50 Damage minus 10 for each card in that Character's Player's Inventory."),
			new InfectedCard("Novistador", 				66, 3, 3, 15, 10, 1, false, "When this Infected is Revealed, if the Exploring Character's Player has 3 or more Actions in their Play Area, this Infected cannot receive Damage during this turn."),
			new InfectedCard("Zombie Security Guard",	67, 3, 3, 15, 10, 1, false, "When this Infected is Defeated, the Exploring Character's Player gets +20 Gold and +1 Buy during this turn."),
			new InfectedCard("Zombie Technician", 		68, 3, 3, 20, 20, 2, false, ""),
			new InfectedCard("Verdugo", 				69, 2, 3, 40, 30, 4, false, "When this Infected is Revealed, if the Exploring Character's Player has 5 or less cards in their Inventory, this Infected cannot receive Damage during this turn."),
			new InfectedCard("Ivy", 					70, 2, 3, 20, 20, 1, false, "When this Infected is Defeated, the Exploring Character Heals their Health by 20."),
			new InfectedCard("Neptune", 				71, 2, 3, 30, 10, 2, false, "When this Infected is Revealed, if the Exploring Character has 30 or more Damage, this Infected gets +30 Damage during this turn."),
			new InfectedCard("Hunter", 					72, 2, 3, 40, 30, 4, false, "When this Infected is Revealed, the Player with the most Decorations lowers their Character's Maximum Health by 20."),
			new InfectedCard("Cerberus", 				73, 3, 3, 30, 10, 1, false, "When this Infected is Revealed, it gets -20 Health during this turn if the Exploring Character is using 2 or more Weapons."),
