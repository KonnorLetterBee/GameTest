...
public class Expansion {
	...
	public static class BaseSet extends Expansion {
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Albert Wesker",					"CH", 1,  exp, 100, 
			...
			new CharacterCard("Sheva Alomar",					"CH", 4,  exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Barry Burton",					"CH", 5,  exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Ada Wong",	 					"CH", 6,  exp, 70, 
			...
			new CharacterCard("Chris Redfield",					"CH", 8,  exp, 120, 
					  ...
					  "", null),
			new CharacterCard("Jill Valentine",					"CH", 9,  exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Rebecca Chambers",				"CH", 10, exp, 70, 
	...
	public static class AlliancesExpans  extends Expansion{
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Carlos Oliveira",				"CH", 11, exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Josh Stone",						"CH", 12, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Steve Burnside",					"CH", 13, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Jack Krauser",					"CH", 14, exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Hunk",							"CH", 15, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Jill Valentine (Brainwashed)",	"CH", 16, exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Billy Coen",						"CH", 17, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Leon S. Kennedy",				"CH", 18, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Chris Redfield",					"CH", 19, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Claire Redfield",				"CH", 20, exp, 80, 
	...
	public static class OutbreakExpans  extends Expansion{
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Excella Gionne",					"CH", 21, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Kevin Ryman",					"CH", 22, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("David King",						"CH", 23, exp, 80, 
			...
			new CharacterCard("Jill Valentine",					"CH", 25, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Leon S. Kennedy",				"CH", 26, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Ada Wong",						"CH", 27, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Chris Redfield",					"CH", 28, exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Rebecca Chambers",				"CH", 29, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Hunk",							"CH", 30, exp, 90, 
		...
		public InfectedCharacterCard[] infecCharacters() { return new InfectedCharacterCard[] {
				new InfectedCharacterCard("Zombie A", 31, exp, 140, "When Berserker Attacks, all other non-Infected Characters that Berserker is not Attacking take 10 Damage.", 0, null),
				new InfectedCharacterCard("Zombie B", 32, exp, 140, "When a Character's Infection Level increases by 1 or more due to an effect, you can Trash an Infection card from your Hand.  In that case, increase that Character's Infection Level by 1 more.", 5, null),
		...
		public InfectionCard[] infections() { return new InfectionCard[] {
			new InfectionCard("Claw", 				1, 3, 5, 10, "The Player controlling the Character you Attacked can only play 1 Action on their next turn.", null),
			new InfectionCard("Virulent Frenzy", 	2, 3, 6, 0,  "Look at the top 3 cards of your Inventory and Trash all non-Infection cards.  Move the rest to the top of your Inventory in any order.", null),
			new InfectionCard("Bile Vomit",			3, 3, 6, 5,  "The Character your Character is Attacking takes 5 Damage for each other \"Bile Vomit\" used this turn.", null),
			new InfectionCard("Slough Armor",		4, 3, 6, 0,  "When your Character is Attacked, you can Discard this card from your Hand.  In that case, reduce the Damage of 1 Weapon neing used by 20.", null),
			new InfectionCard("Drag", 				5, 3, 6, 0,  "While there are 2 or more non-Infected Characters, the Character your Character is Attacking this turn cannot Attack your Character on their next turn.", null),
			new InfectionCard("Devour", 			6, 3, 6, 5,  "Heal your Character's Health by 20.", null),
			new InfectionCard("Infection", 			7, 3, 5, 0,  "Increase the Infection Level of the Character your Character is Attacking by 1.", null),
		}; }
		public MansionCard[] mansion() { return new MansionCard[] {
	...
	public static class NightmareExpans  extends Expansion{
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Chris Redfield",					"CH", 34, exp, 90, 
					  ...
					  0, "",
					  "", null),
			new CharacterCard("Sergei Vladimir",				"CH", 35, exp, 100, 
					  ...
					  "", null),
			new CharacterCard("Luis Sera",						"CH", 36, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Josh Stone",						"CH", 37, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Mikhail Victor",					"CH", 38, exp, 80, 
			...
			new CharacterCard("Mysterious Mask",				"CH", 40, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Albert Wesker",					"CH", 41, exp, 110, 
					  ...
					  "", null),
			new CharacterCard("Leon S. Kennedy",				"CH", 42, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Ada Wong",						"CH", 43, exp, 70, 
	...
	public static class MercenariesExpans extends Expansion {
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Hunk",			"CH", 45,  exp, 90, 
		...
		public SkillsCard[] skills() { return new SkillsCard[] {
			new SkillsCard("Medic Lv. 1", 4, 4, exp, 0, "When you would Heal your Character, you can Heal that amount, plus 10 instead.", 1, null),
			new SkillsCard("Medic Lv. 2", 5, 5, exp, 0, "When you Heal your Character, you can Trash 1 card from your Discard Pile.", 2, null),
			new SkillsCard("Medic Lv. 3", 6, 6, exp, 0, "At the beginning of your turn, Heal your Character's Health by 20.  If your Character is at Maximum Health, you can get +1 Explore during this turn instead.", 5, null),
		}; }
	...
	public static class PromoCharacters1  extends Expansion{
		...
		public CharacterCard[] characters() { return new CharacterCard[] {
			new CharacterCard("Chris Redfield",				"PR", 1, 101, exp, 90, 
					  ...
					  "", null),
			new CharacterCard("Jill Valentine",				"PR", 2, 102, exp, 80, 
					  ...
					  0, "",
					  "", null),
			new CharacterCard("George Hamilton",			"PR", 3, 103, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Jim Chapman",				"PR", 4, 104, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Albert Wesker",				"PR", 5, 105, exp, 100, 
					  ...
					  "", null),
			new CharacterCard("Yoko Suzuki", 				"PR", 6, 106, exp, 70, 
					  ...
					  "", null),
			new CharacterCard("Alyssa Ashcroft", 			"PR", 7, 107, exp, 80, 
					  ...
					  "", null),
			new CharacterCard("Cindy Lennox", 				"PR", 8, 108, exp, 70, 
